...
public class MyStorage {
    ...
    static void prod_input(Scanner s) {
        ...
        String productsName = s.nextLine();
        for (int i = 0; i < products.length; i++) {
            if (products[i].equals(EMPTY)) {
                products[i] = productsName;
                break;
            }
        }
        ...
        for (int i = 0; i < products.length; i++) {
            System.out.printf("> %s%n", products[i]);
        }
    ...
    static void prod_remove(Scanner s) {
        ...
        System.out.println("제품 취소가 완료됬습니다.");
    }
    ...
    public static void prod_amount_add(Scanner s) {
        ...
        for (int i = 0; i < products.length; i++) {
            System.out.printf("> %s : %d개%n", products[i], counts[i]);
        }
